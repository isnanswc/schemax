...
export const BookOverviewTab: React.FC<BookOverviewTabProps> = ({
  ...
  return (
    <div className="space-y-5 pb-24">
      {/* Book Hero Card */}
      <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-4 sm:p-6 shadow-md flex flex-col sm:flex-row gap-5">
        ...
        <div className="w-32 sm:w-40 mx-auto sm:mx-0 flex-shrink-0 flex flex-col items-center gap-2">
          ...
          />
          <label className="text-[11px] text-amber-400 hover:text-amber-300 font-semibold cursor-pointer underline flex items-center gap-1">
        ...
        <div className="flex-1 flex flex-col justify-between space-y-3">
              ...
              {isEditingSynopsis ? (
                <div className="space-y-2">
                  <textarea
                    ...
                    className="w-full p-2.5 text-xs bg-slate-950 border border-slate-700 rounded-xl text-white focus:outline-none focus:border-amber-400"
                  />
                ...
                <div
                  ...
                  className="group cursor-pointer p-2.5 rounded-xl bg-slate-950/40 hover:bg-slate-950/70 border border-slate-800/60 transition"
                >
          ...
          <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-800/80">
            <button
              ...
              className="bg-slate-950/60 hover:bg-slate-950 p-2 rounded-xl border border-slate-800 text-left transition"
            >
            ...
            <button
              ...
              className="bg-slate-950/60 hover:bg-slate-950 p-2 rounded-xl border border-slate-800 text-left transition"
            >
              <div className="flex items-center gap-1.5 text-pink-400 text-xs font-semibold mb-0.5">
                <Compass className="w-3.5 h-3.5" />
                <span>Lore</span>
              </div>
              <span className="text-sm font-bold text-white">{entities.length}</span>
            </button>
            ...
            >
              ...
              <span className="text-sm font-bold text-white">{mediaList.length}</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 shadow-sm space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-white">Target Kata & Capaian</h3>
          </div>
      ...
      <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4 flex items-center justify-between">
        <div>
          <h4 className="text-xs font-bold text-white">Ekspor & Cadangkan Buku</h4>
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 py-2 px-3 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-semibold transition active:scale-95 border border-slate-700"
        >
