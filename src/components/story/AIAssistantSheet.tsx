        ...
        <div className="flex items-center justify-between px-4 sm:px-5 py-3 border-b border-slate-800/80 bg-slate-950/60 flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400">Gemini & Groq Multi-Fallback Engine</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1.5 rounded-xl bg-slate-800 text-slate-400 hover:text-amber-400 transition"
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-3.5 no-scrollbar">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-2.5 bg-slate-950 border border-slate-800 rounded-xl text-xs text-slate-200 placeholder-slate-600 focus:outline-none focus:border-amber-400 leading-relaxed resize-none"
            />
          </div>
          ...
          {currentAttempts.length > 0 && (
            <div className="space-y-1 bg-slate-950/80 p-2.5 rounded-xl border border-slate-800/80 text-[11px]">
              ...
              {currentAttempts.map((att, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  {att.status === 'success' && <span className="w-2 h-2 rounded-full bg-emerald-400" />}
          ...
          {error && (
            <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-2xl text-xs text-red-300 space-y-1">
              ...
              <button
                type="button"
                onClick={onOpenAISettings}
                className="mt-1 text-amber-400 underline font-semibold text-[11px]"
              >
          ...
          {/* AI Result Card */}
          {result && (
            <div className="bg-slate-950 border border-amber-500/30 rounded-2xl p-3.5 space-y-3 shadow-md animate-in zoom-in-95 duration-150">
              <div className="flex items-center justify-between border-b border-slate-800/80 pb-2">
                <div className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                  <span className="text-xs font-bold text-white">Hasil Kreasi AI</span>
              ...
              {/* Generated Text */}
              <div className="text-xs sm:text-sm text-slate-200 leading-relaxed max-h-56 overflow-y-auto no-scrollbar font-serif italic p-1">
                {result.text}
              </div>
              ...
              <div className="flex items-center gap-2 pt-2 border-t border-slate-800/60">
                <button
                  ...
                  className="flex-1 py-2 px-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs transition active:scale-95 text-center"
                >
                  Sisipkan ke Naskah
                </button>
                ...
                {selectedText && (
                  <button
                    ...
                    className="flex-1 py-2 px-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs transition active:scale-95 text-center"
                  >
                    Ganti Kalimat Asli
                  </button>
                )}
